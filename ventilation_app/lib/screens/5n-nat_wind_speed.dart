            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20.0),
                  Text(
                      "Opening percentage: ${calculationState.openpercentage2}",
                      style: const TextStyle(fontSize: 24)),
                  Text("WID UNIT: ${calculationState.unitWindowWidth2}",
                      style: const TextStyle(fontSize: 24)),
                  Text("WID NUM: ${calculationState.windowwidth2}",
                      style: const TextStyle(fontSize: 24)),
                  Text("HEIGHT UNIT: ${calculationState.unitWindowHeight2}",
                      style: const TextStyle(fontSize: 24)),
                  Text("HEIGHT NUM: ${calculationState.windowheight2}",
                      style: const TextStyle(fontSize: 24)),
